  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8 text-gray-800">TailwindCSS Transition 강의</h1>

        {/* 기본 Transition 개념 */}
        <section className="mb-12 bg-white rounded-lg p-6 shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">1. 기본 Transition</h2>
          <p className="mb-6 text-gray-600">
            Transition은 CSS 속성이 변경될 때 부드러운 애니메이션 효과를 만들어줍니다.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Duration 예제 */}
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-gray-700">Duration (지속시간)</h3>
            ...
            {/* Easing 예제 */}
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-gray-700">Easing (이징)</h3>
              <div className="space-y-2">
        ...
        <section className="mb-12 bg-white rounded-lg p-6 shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">2. Transform Transitions</h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Scale */}
            <div className="text-center">
              <h3 className="text-lg font-medium mb-4 text-gray-700">Scale (크기 변화)</h3>
              <button
              ...
              <p className="mt-2 text-sm text-gray-600">클릭해서 크기 변화 확인</p>
            </div>

            {/* Rotate */}
            <div className="text-center">
              <h3 className="text-lg font-medium mb-4 text-gray-700">Rotate (회전)</h3>
              <button
            ...
            {/* Translate */}
            <div className="text-center">
              <h3 className="text-lg font-medium mb-4 text-gray-700">Translate (이동)</h3>
        ...
        {/* 고급 Transition 효과 */}
        <section className="mb-12 bg-white rounded-lg p-6 shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">3. 고급 Transition 효과</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* 색상 변화 + Transform 조합 */}
            <div className="text-center">
              <h3 className="text-lg font-medium mb-4 text-gray-700">복합 효과</h3>
              <button
              ...
              <p className="mt-2 text-sm text-gray-600">색상, 크기, 그림자 동시 변화</p>
            </div>

            {/* Opacity 변화 */}
            <div className="text-center">
              <h3 className="text-lg font-medium mb-4 text-gray-700">Opacity (투명도)</h3>
              <button
              ...
              <Transition show={isVisible}>
                <div
                  ...
                  transition-opacity duration-500 ease-in-out opacity-100 data-closed:opacity-0`}
                >
        ...
        {/* 실전 예제 */}
        <section className="mb-12 bg-white rounded-lg p-6 shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">4. 실전 UI 예제</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-2">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">마우스를 올려보세요!</p>
              </div>
            </div>
        ...
        <section className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">💡 Transition 활용 팁</h2>
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">•</span>
              <code className="bg-gray-100 px-2 py-1 rounded text-sm">transition-all</code>을 사용하면 모든 속성에
              transition이 적용됩니다.
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">•</span>
              성능을 위해 <code className="bg-gray-100 px-2 py-1 rounded text-sm">transform</code>과{" "}
              <code className="bg-gray-100 px-2 py-1 rounded text-sm">opacity</code> 속성을 우선 사용하세요.
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">•</span>
              <code className="bg-gray-100 px-2 py-1 rounded text-sm">will-change-transform</code>을 사용하면 복잡한
              애니메이션의 성능을 향상시킬 수 있습니다.
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">•</span>
              접근성을 위해 <code className="bg-gray-100 px-2 py-1 rounded text-sm">motion-reduce:transition-none</code>
              을 고려하세요.
            </li>
          </ul>
        </section>
